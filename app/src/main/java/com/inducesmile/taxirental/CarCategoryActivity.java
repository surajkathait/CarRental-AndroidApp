...
public class CarCategoryActivity extends AppCompatActivity {
    ...
    private List<CarListObject> getTestData() {
        ...
        testData.add(new CarListObject(1, "SWIFT", "", "", "", "", "", "",6000));
        testData.add(new CarListObject(1, "BALENO", "", "", "", "", "", "", 4000));
        testData.add(new CarListObject(1, "CELERIO", "", "", "", "", "", "", 5000));
        testData.add(new CarListObject(1, "SANTRO", "", "", "", "", "", "", 4000));
        testData.add(new CarListObject(1, "ERTIGA", "", "", "", "", "", "", 4000));
        return testData;
    }
}
